...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/room/order/accept-pay").hasAuthority("ADMIN")
                ...
                .antMatchers("/hotelHall/order/accept-pay").hasAuthority("ADMIN")
                ...
                .antMatchers("/object/order/accept-pay").hasAuthority("ADMIN")
